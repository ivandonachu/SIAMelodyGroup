...
$sql_customer = mysqli_query($koneksi, "SELECT no_registrasi, harga_55kg, harga_12kg FROM customer WHERE nama_customer = '$nama_customer'");
...
mysqli_query($koneksi, "INSERT INTO penjualan_non_pso VALUES('','$tanggal','$no_registrasi','$nama_akun','$pembayaran','$qty_55kg','$harga_55kg','$qty_12kg','$harga_12kg',
                                                            '$jumlah','$status_penjualan','$keterangan','$file')");

//data transaksi
$sql_penjualan = mysqli_query($koneksi, "SELECT * FROM penjualan_non_pso ORDER BY no_penjualan DESC LIMIT 1");
...
echo "<script>alert('Data Penjualan Berhasil di Input'); window.location='../view/VPenjualanNonPSO?tanggal1=$tanggal_awal&tanggal2=$tanggal_akhir';</script>";
exit;
