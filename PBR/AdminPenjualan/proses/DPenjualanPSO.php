...
mysqli_query($koneksi,"DELETE FROM penjualan_pso WHERE no_penjualan = '$no_penjualan'");




	
		echo "<script>alert('Data Penjualan Berhasil di Hapus'); window.location='../view/VPenjualanPSO?tanggal1=$tanggal_awal&tanggal2=$tanggal_akhir';</script>";exit;
